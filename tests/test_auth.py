...
class TestAuthRoutes:
    ...
    def test_authorize_with_new_user(self, mock_login_user, mock_create_user, 
                                   mock_get_user, mock_google, app, app_ctx):
    ...
    @patch('website.views.auth_views.get_user')
    @patch('website.views.auth_views.login_user')
    def test_authorize_with_existing_user(self, mock_login_user, mock_get_user, 
                                        mock_google, app, app_ctx):
